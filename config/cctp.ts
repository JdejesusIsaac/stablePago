export type DomainKey = "ETH-SEPOLIA" | "AVAX-FUJI" | "ARB-SEPOLIA" | "BASE-SEPOLIA" | "MATIC-AMOY";
...
interface ContractAddresses {
  ...
  messageTransmitter: HexAddress;
  tokenMinter: HexAddress;
  usdc: HexAddress;
}
...
interface AbiConfig {
  usdc: AbiFragment[];
  tokenMessenger: AbiFragment[];
  messageTransmitter: AbiFragment[];
}
